...
describe('EventEmitter', () => {
    test('The event must be handled', () => {
        let handled = false;
    ...
    test('The event must pass arguments', () => {
        let isCorrect = false;
        const emitter = new EventEmitter();
    ...
    test('There must be a correct order of emission', () => {
    ...
    test('All events with the name "event" must be unsubscribed', () => {
    ...
    test('All event listeners must unsubscribed', () => {
